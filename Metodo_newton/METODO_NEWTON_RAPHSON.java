 ...
 * @author vya-a
 */
public class METODO_NEWTON_RAPHSON extends javax.swing.JFrame {
    ...
    static String Valor = "", Valor1 = "", Valor2 = "", Valor3 = "", Valor4 = "", Valor5 = "", Valor6 = "", error = "", Xa = "", REDO = "";

    /**
     * Creates new form METODO_NEWTON_RAPHSON
     */
    ...
    private void btncalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncalcularActionPerformed
        ...
        Valor = txtconstante.getText();//constate
        Valor1 = txtgrado1.getText();//grado 1
        ...
        Xa = txtintervalo1.getText(); //xa=x0//llamamos el dato txtintervalo y lo metemos en una variable string
        xa = Double.parseDouble(Xa);//convertimos de string a double
        intervalo1 = xa;
        REDO = txtredondeo.getText();
        ...
        System.out.println("ERRR: " + ERROR);
            ...
            //case 0:
                ...
                fxa = (valor1 * (Math.pow(intervalo1, 1)) + valor);
                ...
                //break;
            //grado 6
                System.out.println("entraste a grado 6");
                ...
                //fxa = ((valor6* (Math.pow(xa, 6))) +(valor5* (Math.pow(xa, 5))) +(valor4* (Math.pow(xa, 4))) +(valor3* (Math.pow(xa, 3))) + (valor2 * (Math.pow(xa, 2))) + ((valor1 * (Math.pow(xa, 1)))) + valor);
                System.out.println("fxa : " + String.format("%." + redondeo + "f", fxa));
                valor = valor1 * 1;
                ...
                fxb = (((valor5 * (Math.pow(intervalo1, 5))) + (valor4 * (Math.pow(intervalo1, 4))) + (valor3 * (Math.pow(intervalo1, 3))) + (valor2 * (Math.pow(intervalo1, 2))) + (valor1 * (Math.pow(intervalo1, 1))) + valor));
                System.out.println("fxb:derivacion " + String.format("%." + redondeo + "f", fxb));//0
    ...
    public void pio() {
        //revisado y esta bien 20/01/2023
        do {
            ...
            System.out.println("valor:5 " + valor5);
            fxb = (((valor5 * (Math.pow(intervalo1, 5))) + (valor4 * (Math.pow(intervalo1, 4))) + (valor3 * (Math.pow(intervalo1, 3))) + (valor2 * (Math.pow(intervalo1, 2))) + (valor1 * (Math.pow(intervalo1, 1))) + valor));
            System.out.println("fxb:derivacion " + String.format("%." + redondeo + "f", fxb));
            //XRNV = XRN;
            XRN = (intervalo1 - (fxa / fxb));
            System.out.println("XRN: " + XRN);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(METODO_NEWTON_RAPHSON.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new METODO_NEWTON_RAPHSON().setVisible(true);
            }
        });
    }
